  ...
  return (
    <div className='container py-5 h-100'>
        ...
        <div class="carousel-inner pt-2">
            ...
            <div id = "home-feedbackItem" className="row d-flex justify-content-center">
            <div className="col-md-8 col-lg-9 col-xl-8">
            <div className="d-flex">
                <div id = "home-feedbackImage"className="flex-shrink-0">
                ...
                <div className="flex-grow-1 ps-3">
                    <figure>
                        ...
                        <p>
                            ...
                            <span id = "home-feedbackText" className="font-italic">Bản thân em thấy việc tìm được người giáo viên tận tâm là vô cùng quan trọng. Em học xong khóa chị Chi từ tháng 3 nhưng đến tận tháng 5 e mới thi mà chị vẫn gửi em tài liệu để ôn... Nói chung là chị Chi 10 điểm tận tâm ạ.</span>
                        </p>
                        </blockquote>
            ...
            <div className="d-flex">
                ...
                <div className="flex-grow-1 ps-3">
                    <figure>
                        ...
                        <p>
                            <i className="fas fa-quote-left fa-lg text-warning me-2"></i>
                            <span id = "home-feedbackText" className="font-italic">Em vô cùng biết ơn chị Chi, bố mẹ cũng như những người bạn vì đã giúp đỡ em về cả mặt tinh thần lẫn mặt học tập trong quá trình ôn thi ạ, và em chúc chị Chi sẽ càng gặt hái được nhiều thành công trong công việc giảng dạy!</span>
                        </p>
                        </blockquote>
                        <figcaption className="blockquote-footer mb-5 ">
                        Vũ Hiền Thảo
            ...
            <div className="d-flex">
                ...
                <div className="flex-grow-1 ps-3">
                    <figure>
                        ...
                        <p>
                            <i className="fas fa-quote-left fa-lg text-warning me-2"></i>
                            <span id = "home-feedbackText" className="font-italic">Tụi em đạt được số điểm kỳ vọng này không chỉ nhờ sự nỗ lực của bản thân mà còn được sự giúp đỡ, hỗ trợ của rất nhiều người khác, đặc biệt là gia đình em và chị Chi - người đã dẫn dắt tụi em suốt quá trình dài này, kể cả lúc tụi em đã học hết khóa của chị.</span>
                        </p>
                        </blockquote>
                        <figcaption className="blockquote-footer mb-5">
